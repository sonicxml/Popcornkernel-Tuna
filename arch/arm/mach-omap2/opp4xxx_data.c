...
#define OMAP4460_VDD_MPU_OPPTURBO_UV		1100000
#define OMAP4460_VDD_MPU_OPPNITRO_UV		1250000
#define OMAP4460_VDD_MPU_OPPOC_UV		1350000 //1.35GHz
#define OMAP4460_VDD_MPU_OPP_OC_PLUS		1420000 //1.45GHz
...
#define OMAP4460_VDD_CORE_OPP50_UV		925000
#define OMAP4460_VDD_CORE_OPP100_UV		1125000
...
static struct omap_opp_def __initdata omap446x_opp_def_list[] = {
	...
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", false, 1450000000, OMAP4460_VDD_MPU_OPP_OC_PLUS),
	/* L3 OPP1 - OPP50 */
...
int __init omap4_opp_init(void)
{
	...
	if (!r) {
			...
			omap4_mpu_opp_enable(1450000000);
	}
