...
#define OMAP4460_VDD_MPU_OPP10_UV		900000
...
#define OMAP4460_VDD_MPU_OPP_OC_PLUS		1380000

struct omap_volt_data omap446x_vdd_mpu_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPP10_UV, OMAP44XX_CONTROL_FUSE_MPU_OPP10, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	...
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPOC_UV, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROOC, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPP_OC_PLUS, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROOC, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0),
};
...
struct omap_volt_data omap446x_vdd_iva_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4460_VDD_IVA_OPPTURBO_UV, OMAP44XX_CONTROL_FUSE_IVA_OPPTURBO, 0xfa, 0x23, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0),
};

#define OMAP4460_VDD_CORE_OPP10_UV		800000
#define OMAP4460_VDD_CORE_OPP50_UV		900000
#define OMAP4460_VDD_CORE_OPP100_UV		1100000
#define OMAP4460_VDD_CORE_OPP100_OV_UV		1250000

struct omap_volt_data omap446x_vdd_core_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP4460_VDD_CORE_OPP10_UV, OMAP44XX_CONTROL_FUSE_CORE_OPP10, 0xf4, 0x0c, OMAP_ABB_NONE),
...
static struct omap_vdd_dep_volt omap446x_vdd_mpu_core_dep_data[] = {
	{.main_vdd_volt = OMAP4460_VDD_MPU_OPP10_UV, .dep_vdd_volt = OMAP4460_VDD_CORE_OPP10_UV},
	...
	{.main_vdd_volt = OMAP4460_VDD_MPU_OPP_OC_PLUS, .dep_vdd_volt = OMAP4460_VDD_CORE_OPP100_UV},
};
...
static struct omap_opp_def __initdata omap446x_opp_def_list[] = {
	/* MPU OPP0 - OPP10 */
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", true, 192000000, OMAP4460_VDD_MPU_OPP10_UV),
	/* MPU OPP1 - OPP50 */
	...
	/* MPU OPP3 - OPP-Turbo */
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", true, 1060000000, OMAP4460_VDD_MPU_OPPTURBO_UV),
	/* MPU OPP4 - OPP-Nitro */
	...
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", false, 1420000000, OMAP4460_VDD_MPU_OPP_OC_PLUS),
	/* L3 OPP1 - OPP50 */
...
//	OPP_INITIALIZER("iva", "dpll_iva_m5x2_ck", "iva", false, 500000000, OMAP4460_VDD_IVA_OPPNITRO_UV),
	/* SGX OPP0 - OPP10 */
	OPP_INITIALIZER("gpu", "dpll_per_m7x2_ck", "core", true, 120000000, OMAP4460_VDD_CORE_OPP10_UV),
	/* SGX OPP1 - OPP50 */
	...
	OPP_INITIALIZER("gpu", "dpll_per_m7x2_ck", "core", false, 460000000, OMAP4460_VDD_CORE_OPP100_OV_UV),
